...
/**
 * Class m231007_101426_add_data_to_text_block_table
 */
class m231007_101426_add_data_to_text_block_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        $this->batchInsert('{{%text_block}}', ['shortcut', 'text'], [
            ['about1', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod
            ...
            ['about2', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod
            tincidunt ut lao dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis
            nostrud exerci tation ullamcorper lobortis
            nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hend rerit in
            vulputate esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros
            ...
            ['about3', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod
    ...
    {
        echo "m231007_101426_add_data_to_text_block_table cannot be reverted.\n";
